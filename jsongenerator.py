        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": f"""
                    ...
                    each card in the deck.   You'll be given a theme and will create 10 cards that follow that theme.  Each
                    card has a action and effect that should follow the theme.  Please remember to ONLY return the JSON, no
